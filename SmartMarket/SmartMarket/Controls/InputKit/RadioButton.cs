...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    public class RadioButton : StackLayout
    {
        ...
        {
            Color = Color.Black, //Color.Accent,
            BorderColor = Color.Black,
            TextColor = Color.Black,//(Color)Label.TextColorProperty.DefaultValue,
            //Size = (Math.Max(App.DisplayScreenWidth, App.DisplayScreenHeight) > 1620) ? 16 + 4 : 16,
            Size = (double)((double)App.Current.Resources["NormalLabelFont"]), //Device.GetNamedSize(Device.RuntimePlatform == Device.iOS ? NamedSize.Medium : NamedSize.Small, typeof(Label)),
            CornerRadius = -1,
            //FontSize = (Math.Max(App.DisplayScreenWidth, App.DisplayScreenHeight) > 1620) ? 16 + 4 : 16,
            FontSize = (double)((double)App.Current.Resources["NormalLabelFont"]), //Device.GetNamedSize(Device.RuntimePlatform == Device.iOS ? NamedSize.Medium : NamedSize.Small, typeof(Label)),
        };
        //.92
        //1.66 minReq
        ...
        {
            TextColor = GlobalSetting.BorderColor,
            Text = "◯",
            VerticalTextAlignment = TextAlignment.Center,
            HorizontalTextAlignment = TextAlignment.Center,
            VerticalOptions = LayoutOptions.Center,
            FontSize = GlobalSetting.Size,
        };

        private Label lblFilled = new Label
        {
            TextColor = GlobalSetting.Color,
            Text = "●",
            IsVisible = false,
            Scale = 0.9,
            VerticalTextAlignment = TextAlignment.Center,
            HorizontalTextAlignment = TextAlignment.Center,
            VerticalOptions = LayoutOptions.Center,
            FontSize = GlobalSetting.Size * .92
        };
        ...
        public RadioButton()
        {
            ...
            lblEmpty.FontSize = lblText.FontSize * 1;
            lblFilled.FontSize = lblText.FontSize * 1;
        ...
        {
            get => lblText.FontSize;
            set { lblText.FontSize = (double)App.Current.Resources["NormalLabelFont"]; }
        }
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        public static readonly BindableProperty TextProperty = BindableProperty.Create(nameof(Text), typeof(string), typeof(RadioButton), string.Empty, propertyChanged: (bo, ov, nv) => (bo as RadioButton).Text = (string)nv == "SmartMarket.Models.Templates.Controls.InputSelectionModel" ? string.Empty : (string)nv);
